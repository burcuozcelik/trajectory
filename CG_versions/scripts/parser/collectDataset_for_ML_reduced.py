...
for solver in solvers:
	...
	for ch in chunk_size:
		for dt in dataset_size:
			for tr in training_size:
				mldir=results_dir + detector + "/" + solver +  "/" + str(dt) + "_" + str(ch) + "_" + str(tr) + "_" + "5000" + "/"
				print mldir
				...
				#cg_1_0.8_13_af_shell4.test.pred
				#cg_baseline_1_0.8_10_bcsstk14.out
				for mlfile in mlfiles:
					ml_split = mlfile.split("_")
					if ml_split[4] == "af" or ml_split[4] == "Pres":
						dname=ml_split[5].split(".")
						baseling_fname = ml_split[0] + "_baseline_" + ml_split[1] + "_" + ml_split[2] + "_" + ml_split[3] + "_" + ml_split[4] + "_" + dname[0] + ".out"
					else:
						dname=ml_split[4].split(".")
						baseling_fname = ml_split[0] + "_baseline_" + ml_split[1] + "_" + ml_split[2] + "_" + ml_split[3] + "_" + dname[0] + ".out"
				
					print baseling_fname
					try:
						...
						msg = "Baseline:File does not exist =" + dirbaseline + "/" + baseling_fname
						print msg
						continue
					...
					try:
						...
						msg = "ML:File does not exist=" + mlfile
						print msg
						continue
