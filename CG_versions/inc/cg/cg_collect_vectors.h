   ...
   const Preconditioner &M, int &max_iter, Real &tol)
{
  ...
  /*****************/
  double vec_resids[MAX_NUM_ITERATION];
  double orth_exp1[MAX_NUM_ITERATION];
  double orth_exp2[MAX_NUM_ITERATION];
  double newsum_exp1[MAX_NUM_ITERATION];
  double newsum_exp2[MAX_NUM_ITERATION];
  double newsum_scaler[MAX_NUM_ITERATION];   
/*****************/
